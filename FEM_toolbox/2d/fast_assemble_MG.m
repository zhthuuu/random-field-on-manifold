...
function [M, G] = fast_assemble_MG(P, t, normvecs, varargin)
    numNodes = length(P);
    ...
    idx_vec = 1:num_dof^2;
    for i = 1:numElements
        Me = get_Me(P, t, i, normvecs);
        if nargin==3
            Ge = get_Ge(P, t, i, normvecs);
        elseif nargin==5
            Ge = get_anisotropic_Ge(P, t, i, normvecs, varargin{1}, varargin{2});
        else
